<?php
$nombre_tabla=$variableadmin_prefijo_tablas."core_tiposfuncionalidad";
...
$ruta = 'array_TiposFuncionalidad.php'; include("$ruta");
...
$publicar_problema="1";
$datosPredeterminados="insertoTiposFuncionalidad_datosPredeterminados"; //sin ".php"
...
foreach ($Campo1 as $value) { // INICIO: foreach #1
	...
	foreach ($Campo1_explode as $indice_explode => $value_explode) { // INICIO: foreach #2
		...
		$ruta = 'insertoTiposFuncionalidad_ejecuto.php'; include("$ruta");
	}  // FIN: foreach #2
