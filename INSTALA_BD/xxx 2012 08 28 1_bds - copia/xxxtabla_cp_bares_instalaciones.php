...
$nombre_tabla=$variableadmin_prefijo_tablas."cp_bares_instalaciones";
...
IDInstalacion bigint(11) NOT NULL auto_increment,
Nombre varchar(255),".
...
$publicar_problema="1";
$datosPredeterminados="tabla_perfiles_datosPredeterminados";
