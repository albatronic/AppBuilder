...
$sql="insert into $nombre_tabla (id_perfildeusuario,num_perfildeusuario,perfildeusuario,esdatopredeterminado,orden,publicar,es_de_superadministrador,solo_visible_para_superadministrador,fechapublicacion,usuariopublicacion,fechaultimamodificacion,usuarioultimamodificacion,num_perfildeusuario_md5) values(null, '$num_dato', '$dato', 'SI', '$num_dato', 'SI', 'SI', 'NO', '$datetime_ahora', '1', '$datetime_ahora', '1', '$num_perfildeusuario_md5')";
$res=mysql_query($sql,$db);
