...
$modifico01=str_replace($a_acento, "&aacute;", $modifico0); 
...
$modifico01=str_replace($signo_cerrar_interrogacion, "&#63;", $modifico012); 

$modifico001=str_replace($exclamacion_abrir, "&iexcl;", $modifico01); 
$modifico002=str_replace($exclamacion_cerrar, "&#33;", $modifico001); 
$modifico003=str_replace($interrogacion_abrir, "&iquest;", $modifico002); 


$modifico02=str_replace($dolar, "&#36;", $modifico003); 
