...
DeletedBy int(4),
DeletedAt datetime,
Privacidad tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Abstract,ValoresPrivacidad,IDTipo',
Orden bigint(11) NOT NULL DEFAULT '0',
FechaPublicacion datetime,
UrlAmigable varchar(250),
MetatagTitle varchar(250),
MetatagKeywords varchar(250),
MetatagDescription varchar(250),
MetatagTitleSimple tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Abstract,ValoresSN,IDTipo',
MetatagTitlePosicion tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Abstract,ValoresDchaIzq,IDTipo',
MostrarEnMapaWeb tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Abstract,ValoresSN,IDTipo',
ImportanciaMapaWeb varchar(5) NOT NULL DEFAULT '0,5',
ChangeFreqMapaWeb varchar(25) NOT NULL DEFAULT 'monthly' COMMENT 'Abstract,ValoresChangeFreq,IDTipo',";
