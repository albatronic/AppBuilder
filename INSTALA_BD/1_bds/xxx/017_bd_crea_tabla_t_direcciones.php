...
num_direccion_md5 varchar(100) null,
id_pais int,
id_provincia int,
id_localidad int,
id_vias int null,
numero_dela_via varchar(50) null,
km varchar(50) null,
nombre_edificio varchar(150) null,
bloque varchar(50) null,
portal varchar(50) null,
escalera varchar(50) null,
planta varchar(50) null,
puerta varchar(50) null,
urbanizacion varchar(150) null,
codigopostal varchar(50) null,
informacion_adicional varchar(250) null,
nombrecompletovia varchar(250) null,
nombrecompletodireccion varchar(250) null,
...
$variablesubmodulo_nombre_campo_id="id_localidad";
$variablesubmodulo_nombre_campo_md5="num_localidad_md5";
$campoProblema="localidad";
...
foreach ($precargaDeDatos as $indice => $value) {
	...
	$datosPredeterminados = 'datosPredeterminados_t_localidades'; 
