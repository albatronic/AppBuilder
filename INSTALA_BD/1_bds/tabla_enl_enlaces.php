...
$nombre_tabla=$variableadmin_prefijo_tablas."enl_enlaces";
...
IDSeccion bigint(11) COMMENT 'db,enlSecciones,IDSeccion',
Titulo varchar(255),
Subtitulo varchar(255),
Url varchar(255),
Target tinyint(1) DEFAULT '0' COMMENT 'Abstract,TargetEnlace,IDTipo',
EsHttps tinyint(1) DEFAULT '0' COMMENT 'Abstract,ValoresSN,IDTipo',
UrlInternaExterna tinyint(1) DEFAULT '0' COMMENT 'Abstract,UrlInternaExterna,IDTipo',
".
...
KEY EsHttps (EsHttps),
KEY Target (Target),
KEY UrlInternaExterna (UrlInternaExterna)
) ENGINE=MyISAM";
...
// Campo: Perfil
$Campo1 = array("SuperAdministrador","Administrador");


$variablesubmodulo_nombre_campo_id="IDPerfil";
$variablesubmodulo_nombre_campo_md5="PrimaryKeyMD5";
$esdatopredeterminado_problema="1";
$publicar_problema="1";
$datosPredeterminados="tabla_core_perfiles_datosPredeterminados";
