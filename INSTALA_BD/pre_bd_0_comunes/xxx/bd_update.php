...
for ($i=0; $i<$num_campos; $i++){ // INICIO: bucle for
	...
	if(in_array($nombreCampo, $arrayDeCampos)){  // INICIO: if(in_array)
		...
		$camposSqlUpdate.="$nombreCampo='".$$nombreCampo."', "; 
...
//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br>",$sqlupdate;
...
// UPDATE DE CAMPOS CON LOS QUE HEMOS TENIDO QUE HACER ALGUNA OPERACIÓN o COMPOSICIÓN PARTICULAR ___________________________________
$ruta = $f.'/'.$f1.'/'.$variablesubmodulo_update_campos_operados.'.php'; if(file_exists($ruta)){ include("$ruta"); }
