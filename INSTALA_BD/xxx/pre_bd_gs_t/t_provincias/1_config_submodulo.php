...
$variablesubmodulo_titulo_dialogo_nuevo="Nueva Provincia"; 
$variablesubmodulo_mensaje_dialogo_nuevo="Se dispone a crear una<br />Nueva Provincia"; 

//PERMISOS _______________________________________________________________
//Definimos los valores de los Pérmisos Básicos
$variablesubmodulo_id_opcion_permiso_insert=45;
$variablesubmodulo_id_opcion_permiso_update=46;
$variablesubmodulo_id_opcion_permiso_delete=47;
$variablesubmodulo_id_opcion_permiso_list=48;
$variablesubmodulo_id_opcion_permiso_auditoriacampo=49;
...
$variablesubmodulo_nombre_campo_id="id_provincia"; // Nombre del campo "id"
$variablesubmodulo_nombre_campo_md5="num_provincia_md5"; // Nombre del campo "md5"
$variablesubmodulo_nombre_campo_foco="provincia"; // Nombre del campo sobre el que se situar&aacute; el foco del formulario
...
$variablesubmodulo_control_campos_blanco = array("provincia", "longitud", "No puede dejar el campo Provincia en Blanco");
...
$variablesubmodulo_control_datos_repetidos = array("provincia", "", "Ya existe esta Provincia"); // Se trata de un Array donde indicamos los campos que no pueden tener valores repetidos en esta tabla. La información va codificada en bloques de tres Valores. 1:NOMBRE DEL CAMPO DE LA TABLA QUE NO PUEDE TENER VALORES REPETIDOS 2:VALOR QUE TOMARÁ EL CAMPO POR EL HECHO DE ESTAR REPETIDO (normalmente se dejará en blanco) 3:TEXTO DE ERROR. 
...
$variablesubmodulo_listado_abecedario_campo_busqueda="provincia"; // Indicamos sobre que campo hacemos la búsqueda cuando pulsamos un elemento del abecedario.

$variablesubmodulo_listado_campo_ordenacion="provincia"; // Campo por el que haremos la ordenación Alfabética 
...
$variablesubmodulo_listado_campo_condicion_2="provincia"; // Campo en el que realizará la Búsqueda el Campo2 
...
$variablesubmodulo_listado_etiqueta_columna_1="Provincia"; // Indicamos el nombre que tendrá la cabecera de la Columna 1
$variablesubmodulo_listado_campo_columna_1="provincia"; // Indicamos el campo que se mostrará en la Columna 1
...
$variablesubmodulo_listado_criterio_orden_columna_1="provincia"; // Establecemos el campo que se utilizará de criterio para ordenar la columna1. Normalmente este valor coincide con $variablesubmodulo_listado_campo_columna_1
