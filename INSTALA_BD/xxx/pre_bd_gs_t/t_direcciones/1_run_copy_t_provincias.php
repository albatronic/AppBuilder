...
$campo_copy_Padre="id_provincia"; // Nombre del campo del formulario Padre donde se copiará el dato seleccionado en el Pop-Up
$decode_md5="SI"; // Si toma el valor SI, entonces tendremos que decodificar el valor MD5 que se ha seleccionado en el Pop-UP
$campo_ID_popup="id_provincia";// Este es el nombre del campo ID del formulario Popup. Sólo es necesario si  $decode_md5="SI"
$campo_MD5_popup="num_provincia_md5";// Este es el nombre del campo ID_MD5 del formulario Popup.  Sólo es necesario si  $decode_md5="SI"
