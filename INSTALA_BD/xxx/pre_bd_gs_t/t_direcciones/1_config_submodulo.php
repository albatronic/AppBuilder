...
$variablesubmodulo_titulo_dialogo_nuevo="Nueva Direcci&oacute;n"; 
$variablesubmodulo_mensaje_dialogo_nuevo="Se dispone a crear una<br />Nueva Direcci&oacute;n"; 

//PERMISOS _______________________________________________________________
//Definimos los valores de los Pérmisos Básicos
$variablesubmodulo_id_opcion_permiso_insert=35;
$variablesubmodulo_id_opcion_permiso_update=36;
$variablesubmodulo_id_opcion_permiso_delete=37;
$variablesubmodulo_id_opcion_permiso_list=38;
$variablesubmodulo_id_opcion_permiso_auditoriacampo=39;
$variablesubmodulo_script_permisos_particulares="1_permisos_particulares";  // no lleva el ".php"


//CAMPOS BASICOS DE LA TABLA QUE SOPORTA EL MODULO _______________________________________________________________
$variablesubmodulo_nombre_campo_id="id_direccion"; // Nombre del campo "id"
$variablesubmodulo_nombre_campo_md5="num_direccion_md5"; // Nombre del campo "md5"
$variablesubmodulo_nombre_campo_foco=""; // Nombre del campo sobre el que se situar&aacute; el foco del formulario
...
$variablesubmodulo_control_campos_blanco = array("id_pais", "valorcero", "No puede dejar el Pa&iacute;s en Blanco","id_provincia", "valorcero", "No puede dejar la Provincia en Blanco","id_localidad", "valorcero", "No puede dejar la Localidad en Blanco","id_vias", "valorcero", "No puede dejar la V&iacute;a en Blanco");
...
$variablesubmodulo_control_datos_repetidos = array("nombrecompletodireccion", "", "Ya existe esta Direcci&oacute;n"); // Se trata de un Array donde indicamos los campos que no pueden tener valores repetidos en esta tabla. La información va codificada en bloques de tres Valores. 1:NOMBRE DEL CAMPO DE LA TABLA QUE NO PUEDE TENER VALORES REPETIDOS 2:VALOR QUE TOMARÁ EL CAMPO POR EL HECHO DE ESTAR REPETIDO (normalmente se dejará en blanco) 3:TEXTO DE ERROR. 
