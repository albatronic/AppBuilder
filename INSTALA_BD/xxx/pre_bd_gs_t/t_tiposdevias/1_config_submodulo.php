...
$variablesubmodulo_cargar_variables_entorno="SI"; 
...
$variablesubmodulo_titulo_dialogo_nuevo="Nuevo Tipo de V&iacute;a"; 
$variablesubmodulo_mensaje_dialogo_nuevo="Se dispone a crear un<br />Nuevo Tipo de V&iacute;a"; 

//PERMISOS _______________________________________________________________
//Definimos los valores de los Pérmisos Básicos
$variablesubmodulo_id_opcion_permiso_insert=23;
$variablesubmodulo_id_opcion_permiso_update=24;
$variablesubmodulo_id_opcion_permiso_delete=25;
$variablesubmodulo_id_opcion_permiso_list=26;
$variablesubmodulo_id_opcion_permiso_auditoriacampo=27;
...
$variablesubmodulo_nombre_campo_id="id_tiposdevias"; // Nombre del campo "id"
$variablesubmodulo_nombre_campo_md5="num_tiposdevias_md5"; // Nombre del campo "md5"
$variablesubmodulo_nombre_campo_foco="tiposdevia"; // Nombre del campo sobre el que se situar&aacute; el foco del formulario
...
$variablesubmodulo_valores_insert=""; // Es el Script que tiene los valores de los campos NO PREDETERMINADOS que se insertarán inicialmente para este Módulo
...
$variablesubmodulo_control_campos_blanco = array("tiposdevia", "longitud", "No puede dejar el campo TIPO DE V&Iacute;A en blanco");
...
$variablesubmodulo_control_datos_repetidos = array("tiposdevia", "", "Ya existe este TIPO DE V&Iacute;A");
...
$nombre_tabla_t_vias=$variableadmin_prefijo_tablas."t_vias";
$variablesubmodulo_control_dependencias = array($nombre_tabla_t_vias, "id_tiposdevias", "Existen V&iacute;as que tienen asignado este Tipo de V&iacute;a");
...
$variablesubmodulo_listado_abecedario_campo_busqueda="tiposdevia"; // Indicamos sobre que campo hacemos la búsqueda cuando pulsamos un elemento del abecedario.

$variablesubmodulo_listado_campo_ordenacion="tiposdevia"; // Campo por el que haremos la ordenación Alfabética 
...
$variablesubmodulo_listado_campo_condicion_1="tiposdevia"; // Campo en el que realizará la Búsqueda el Campo1 del Buscador del Listado y el ABECEDARIO 
$variablesubmodulo_listado_etiqueta_campo_condicion_1="Tipo de V&iacute;a: "; // Etiqueta del Campo1 del Buscador del Listado
...
$variablesubmodulo_listado_etiqueta_columna_1="Tipo de V&iacute;a"; // Indicamos el nombre que tendrá la cabecera de la Columna 1
$variablesubmodulo_listado_campo_columna_1="tiposdevia"; // Indicamos el campo que se mostrará en la Columna 1
...
$variablesubmodulo_listado_criterio_orden_columna_1="tiposdevia"; // Establecemos el campo que se utilizará de criterio para ordenar la columna1. Normalmente este valor coincide con $variablesubmodulo_listado_campo_columna_1
