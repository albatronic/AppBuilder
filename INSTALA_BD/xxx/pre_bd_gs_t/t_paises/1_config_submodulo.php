...
$variablesubmodulo_titulo_dialogo_nuevo="Nuevo Pa&iacute;s"; 
$variablesubmodulo_mensaje_dialogo_nuevo="Se dispone a crear un<br />Nuevo Pa&iacute;s"; 

//PERMISOS _______________________________________________________________
//Definimos los valores de los Pérmisos Básicos
$variablesubmodulo_id_opcion_permiso_insert=17;
$variablesubmodulo_id_opcion_permiso_update=18;
$variablesubmodulo_id_opcion_permiso_delete=19;
$variablesubmodulo_id_opcion_permiso_list=20;
$variablesubmodulo_id_opcion_permiso_auditoriacampo=21;
...
$variablesubmodulo_nombre_campo_id="id_pais"; // Nombre del campo "id"
$variablesubmodulo_nombre_campo_md5="num_pais_md5"; // Nombre del campo "md5"
$variablesubmodulo_nombre_campo_foco="pais"; // Nombre del campo sobre el que se situar&aacute; el foco del formulario
...
$variablesubmodulo_control_campos_blanco = array("pais", "longitud", "No puede dejar el campo Pa&iacute;s en blanco");
...
$variablesubmodulo_control_datos_repetidos = array("pais", "", "Ya existe un Pa&iacute;s con ese nombre");
...
$variablesubmodulo_control_dependencias = array($nombre_tabla_t_terceros, "num_pais_social", "Existen Terceros que utilizan este Pa&iacute;s en la Dirección Social", $nombre_tabla_t_terceros, "num_pais_comunicaciones", "Existen Terceros que utilizan este Pa&iacute;s en la Dirección de Comunicaciones", $nombre_tabla_t_terceros, "num_pais_empadrona", "Existen Terceros que utilizan este Pa&iacute;s en la Dirección de Empadronamiento");


// LISTADO _______________________________________________________________
$variablesubmodulo_listado_buscador="SI"; // Muestra el Formulario de Búsqueda en la cabecera del Listado 
$variablesubmodulo_listado_abecedario="SI"; // Muestra el ABCEDARIO en el Listado 
$variablesubmodulo_listado_abecedario_campo_busqueda="pais"; // Indicamos sobre que campo hacemos la búsqueda cuando pulsamos un elemento del abecedario.

$variablesubmodulo_listado_campo_ordenacion="pais"; // Campo por el que haremos la ordenación Alfabética 
$variablesubmodulo_listado_orden="asc"; /* Orden en el que se mostrarán inicialmente los resultados del listado (asc=ASCENDENTE;
                                           desc=DESCENDIENTE) */
$variablesubmodulo_listado_tamanio_paginacion=50; // Número de registros que se mostrarán en cada página del listado

$variablesubmodulo_listado_campo_condicion_1="pais"; /* Campo en el que realizará la Búsqueda el Campo1 del Buscador del Listado y el 
                                                        ABECEDARIO */
...
$variablesubmodulo_listado_estilo_columna_0=' style="width:80px; height:30px;"'; // Indicamos el estilo adicional de la columna CERO de la cabecera
$variablesubmodulo_listado_estilo_columna_1=''; // Indicamos el estilo adicional de la columna UNO de la cabecera
$variablesubmodulo_listado_etiqueta_columna_1="Pa&iacute;s"; // Indicamos el nombre que tendrá la cabecera de la Columna 1
$variablesubmodulo_listado_campo_columna_1="pais"; // Indicamos el campo que se mostrará en la Columna 1
...
$variablesubmodulo_listado_criterio_orden_columna_1="pais"; // Establecemos el campo que se utilizará de criterio para ordenar la columna1. Normalmente este valor coincide con $variablesubmodulo_listado_campo_columna_1
