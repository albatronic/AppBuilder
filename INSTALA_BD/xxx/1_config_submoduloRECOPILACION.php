...
$variablesubmodulo_script_permisos_particulares=""; // no lleva el ".php"
...
$variablesubmodulo_control_datos_repetidos_script_particular = "1_controlCamposRepetidos"; // Si existe este Script, entonces el Control de Datos Repetidos, lo hará este SCRIPT PARTICULAR que está en la carpeta del módulo
$variablesubmodulo_control_datos_repetidos = array("nif_cif", "", "Ya existe este NIF/CIF"); // Se trata de un Array donde indicamos los campos que no pueden tener valores repetidos en esta tabla. La información va codificada en bloques de tres Valores. 1:NOMBRE DEL CAMPO DE LA TABLA QUE NO PUEDE TENER VALORES REPETIDOS 2:VALOR QUE TOMARÁ EL CAMPO POR EL HECHO DE ESTAR REPETIDO (normalmente se dejará en blanco) 3:TEXTO DE ERROR. 
