	...
	var imgDir = "/erp/images/calendario/"			// directory for images ... e.g. var imgDir="/img/"
	...
	var selectDateMessage = "Seleccionar la fecha [date]." // do not replace [date], it will be replaced by date.
    ...
    */
    ...
    if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar' style='margin-left: 190px;margin-top: 5px;z-index:+1999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr background='/erp/images/calendario/calback.jpg'><td background='/erp/images/calendario/calback.jpg'><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#FFFFFF'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Cerrar calendario'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
		...
		document.write ("</table></div><div id='selectMonth' style='margin-left: 190px;z-index:+1999;position:absolute;visibility:hidden;'></div><div id='selectYear' style='margin-left: 190px;z-index:+1999;position:absolute;visibility:hidden;'></div>");
	}
...
//---------------------------------------------TRADUCCION EN ESPA�OL-----------------------------------------------------------------------------
	...
	function init()	{
		if (!ns4)
		{
			...
			sHTML1+="<span id='spanYear' style='border-style:solid;border-width:1px;border-color:#fffffff;cursor:pointer' onmouseover='swapImage(\"changeYear\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+selectYearMessage+"\"'	onmouseout='swapImage(\"changeYear\",\"drop1.gif\");this.style.borderColor=\"#ffffff\";window.status=\"\"'	onclick='popUpYear()'></span>&nbsp;"
